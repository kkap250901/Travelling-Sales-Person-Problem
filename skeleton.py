...
##### begin change 1 #####
the_particular_city_file_folder = "Cities"
...
############
#Do Ant colony,Greedy Best First and Genetic Algo
#Improvemeents on Ant Colony are limting the number of nearest neighbours to 8, Phermone smoothing min and max value
#And obviously ranking ant colony is great too.
#For Phermone smoothing is good bc sometimes they converege too quickly and may go to a local min so it is good
#For 8 nearest neighbours its good bc it is comp inexoensive
#Also doing hill climbing and swapping cities work too
print(dist_matrix)

#so i have num_cities and I have the dis matrix 
#Greedy Best First Search
#Division by 0 you have to add a tiny constant to the denominator or
from queue import PriorityQueue

def greedy_best_first_search():

    visited_list = [] * num_cities
